  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center text-white text-center py-32 bg-[url('/src/assets/images/hero-bg.png')] bg-cover bg-center">
      <div className="container relative z-10">
        ...
        <button className="text-white px-1 py-1 rounded-[100px] flex items-center gap-3 mx-auto shadow-lg transition-all duration-300 border border-white/30 bg-white/20 backdrop-blur-sm hover:bg-white/30 hover:border-white/50 group">
